...
import CategorySelector from '../../CategorySelectorPage/components/CategorySelector'
...
export default function RoomConfigPopup({ 
  ...
  const handleCategorySelected = (categories: Category[], mode: 'solo' | 'online', players: any[], name: string) => {
